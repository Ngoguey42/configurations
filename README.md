...
cd; curl -O https://pypi.python.org/packages/source/c/cogapp/cogapp-2.4.tar.gz && tar -zxvf cogapp-2.4.tar.gz && python cogapp-2.4/setup.py install && rm -rf cogapp-2.4
